...
<%
	...
	if(AlipayNotify.verifyNotify(params)){//验证成功
		...
		//System.out.println("sjn_out_trade_no=="+out_trade_no);
		//System.out.println("sjn_trade_status=="+trade_status);
...
enable = Tools.isNumber(c);
	...
	if(trade_status.equals("TRADE_SUCCESS"))
	{
		...
		//System.out.println(i+"_"+cid[i]+"_sql="+sql);
				j++;	
	...
	System.out.println("/3g/zhifubao/notify_url.jsp error :" + e);
